namespace AngleSharp.Css
{
    ...
    public static class PropertyNames
    {
        ...
        /// 富文本线性渐变方向
        /// </summary>
        public static readonly String LinearDirection = "--linear-direction";

        /// <summary>
        /// 渐变填充模式
        /// </summary>
        public static readonly String TileMode = "--tile-mode";

        /// <summary>
        /// 渐变起始颜色
        /// </summary>
        public static readonly String GradientStartColor = "--gradient-start-color";

        /// <summary>
        /// 渐变终止颜色
        /// </summary>
        public static readonly String GradientEndColor = "--gradient-end-color";
    }
}
